# Generated by Powerlevel10k configuration wizard on 2023-12-22 at 08:20 ChST.
...
# solid, white-ornaments, sparse, fluent, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{ROOT,REMOTE,REMOTE_SUDO}_TEMPLATE='%B%n@%m'
